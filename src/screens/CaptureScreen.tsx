      ...
      >
        <div className="icon">
          {/* Font Awesome free "camera" (solid). Inlined as SVG rather than
              ...
              fully self-contained. `currentColor`, not a gradient with two
              hard-coded indigo stops: the app's one gradient belongs to the
              primary action, and a literal hex here stayed the same purple in
              every palette and flavour. .capture-area .icon sets the colour. */}
